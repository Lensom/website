...
const Projects = () => {
  ...
  return (
    <>
      <Canvas className={classes.canvas} orthographic camera={{ zoom: state.zoom, position: [0, 0, 500] }}>
        <Suspense fallback={<Dom center className={classes.loading} children="Loading..." />}>
          <Pages />
          <Startup />
        </Suspense>
      </Canvas>
